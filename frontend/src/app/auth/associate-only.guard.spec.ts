...
import { of } from 'rxjs';
import { associateOnlyGuard } from './associate-only.guard';
import { AuthService } from './auth.service';
import { SetupService } from '../setup/setup.service';
import { SetupStateResponse } from '../setup/models/setup-state.model';

describe('associateOnlyGuard', () => {
  ...
  it('allows an ASSOCIATE onto the dashboard without checking setup state', () => {
    authService.getRole.and.returnValue('ASSOCIATE');

    const result = TestBed.runInInjectionContext(() => associateOnlyGuard({} as any, {} as any));
