...
| 2 | Admin views a paginated, filterable e-PIN issuance/redemption register — `GET /api/admin/epins` | backend | 1 | planned | `2026-08-03-epin-unit-2-admin-register.md` | |
