...
| 3 | Redeeming a nonexistent/already-redeemed e-PIN, or for an unknown associate, is rejected with no side effects | backend | 1 | planned | `2026-08-03-epin-unit-3-redeem-guards.md` | |
