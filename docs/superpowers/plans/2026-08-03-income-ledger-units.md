...
| 4 | screen | Associate "Income Statement" screen — itemized ledger history, tabs per income type, filter by cycle | 2 | merged | `2026-08-14-income-ledger-unit-4-associate-income-statement-screen.md` | `a3f6a1b..2e2c74a` |
