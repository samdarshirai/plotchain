...
| 8 | backend | Admin disburses an approved request — `POST /api/admin/withdrawals/{id}/disburse` | 7 | merged | `2026-08-15-wallet-withdrawal-disburse.md` | `8973dfa..c6545f8` |
| 9 | backend | Associate views own withdrawal history — `GET /api/associates/me/withdrawals` | 6 | merged | `2026-08-15-wallet-withdrawal-associate-history.md` | `df5c9fc..fc75e4b` |
| 10 | screen | Admin "Ledger / Payout Approval" screen — withdrawal request lifecycle | 5, 6, 7, 8 | merged | `2026-08-15-wallet-withdrawal-unit-10-admin-payout-approval-screen.md` | `b8ed45f..1c3f762` |
| 11 | screen | Associate "Payout History" screen — wallet balance + own withdrawal history | 2, 9 | merged | `2026-08-15-wallet-withdrawal-unit-11-associate-payout-history-screen.md` | `fc988fb..3fb207a` |
