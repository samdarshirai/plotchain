...
|---|---|---|---|
| `2026-08-03-role-capability-data-visibility-design.md` | in progress (7/16 already have a pre-existing plan — see units file; units 12–16 are screens, added 2026-08-05) | `2026-08-03-role-capability-units.md` | 1 / 16 |
